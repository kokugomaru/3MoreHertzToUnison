...
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="思い出2<br>から始める" x="120" y="130" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="f.isEpisode1Clear = 1"]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="思い出3<br>から始める" x="120" y="230" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="f.isEpisode2Clear = 1"]
...
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="会話スキップ(通常)" x="120" y="330" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="f.scn_skip = 1" cond="f.scn_skip == 0"]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="会話スキップ(通常)" x="120" y="330" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="f.scn_skip = 0" cond="f.scn_skip == 1"]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="OPスキップ" x="120" y="430" width="150" height="30" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="sf.scn_episodeOP_Skip = 'true' "]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="思い出1序盤スキップ" x="120" y="515" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="sf.scn_episode1OP_Skip = 'true' "]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="思い出1終盤スキップ" x="120" y="615" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="sf.scn_episode1ED_Skip = 'true' "]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="思い出2序盤スキップ" x="120" y="715" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="sf.scn_episode2OP_Skip = 'true' "]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="思い出2終盤スキップ" x="120" y="815" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="sf.scn_episode2ED_Skip = 'true' "]
[glink color="bth06" storage="Develop/debug.ks" target="*Save" text="思い出3序盤スキップ" x="120" y="915" width="150" height="45" clickse="../sound/se/itemdecision.m4a" size="24" bold="true" exp="sf.scn_episode3OP_Skip = 'true' "]
