...
[macro name="SelectItemClickable"]
    [if exp="tf.usingItemInventory1 == 1"]
        [clickable x="1780" y="150" width="100" height="100" target="%target_1" opacity="30" mouseopacity="120" color="&sf.colorScheme[3]"]
    [endif]
    [if exp="tf.usingItemInventory2 == 1"]
        [clickable x="1780" y="250" width="100" height="100" target="%target_2" opacity="30" mouseopacity="120" color="&sf.colorScheme[3]"]
    [endif]
    [if exp="tf.usingItemInventory3 == 1"]
        [clickable x="1780" y="350" width="100" height="100" target="%target_3" opacity="30" mouseopacity="120" color="&sf.colorScheme[3]"]
    [endif]
    [if exp="tf.usingItemInventory4 == 1"]
        [clickable x="1780" y="450" width="100" height="100" target="%target_4" opacity="30" mouseopacity="120" color="&sf.colorScheme[3]"]
    [endif]
    [if exp="tf.usingItemInventory5 == 1"]
        [clickable x="1780" y="550" width="100" height="100" target="%target_5" opacity="30" mouseopacity="120" color="&sf.colorScheme[3]"]
    [endif]
    [if exp="tf.usingItemInventory6 == 1"]
        [clickable x="1780" y="650" width="100" height="100" target="%target_6" opacity="30" mouseopacity="120" color="&sf.colorScheme[3]"]
    [endif]
    [if exp="tf.usingItemInventory7 == 1"]
        [clickable x="1780" y="750" width="100" height="100" target="%target_7" opacity="30" mouseopacity="120" color="&sf.colorScheme[3]"]
    [endif]
[endmacro]
