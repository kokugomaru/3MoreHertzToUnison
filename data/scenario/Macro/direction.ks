...
[macro name="blackout"]
    ...
    [if exp="%exp"]
        ...
        [elsif exp="f.itemVisible[0] == 'true' && f.itemVisible[1] == 'epilogue_true' "]
            ...
            [layer3True]
        [endif]
        [bg storage="%storage_1" time="%time_2|100" time="10" wait="true"]
    [else]
        [bg storage="%storage_2" time="%time_3|100" time="10" wait="true"]
    [endif]
    [mask_off time="2000"]
[endmacro]
...
[macro name="FreeItemDisp"]
    [free layer="2" name="itemDisp" time="10" wait="true"]
    [layer2False]
    [free_filter]
[endmacro]
