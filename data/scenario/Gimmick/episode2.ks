...
[if exp="f.isDressGet == 0 && f.isCurtainGet == 0"]
    ...
    *SelectItemOfBlock
    ...
    [if exp="f.isUsing == 1"]
        ...
        [if exp="f.dimple[0] != '' "]
            [clickJudgment x="485" y="388" width="275" height="300" target="*ReturnLeftSideBlock" opacity="90" mouseopacity="120"]
        [endif]
        [if exp="f.dimple[1] != '' "]
            [clickJudgment x="795" y="388" width="275" height="300" target="*ReturnCenterSideBlock" opacity="90" mouseopacity="120"]
        [endif]
        [if exp="f.dimple[2] != '' "]
            [clickJudgment x="1118" y="388" width="275" height="300" target="*ReturnRightSideBlock" opacity="90" mouseopacity="120"]
        [endif]
...
[endif]
[if exp="f.dimple[0] == '' "]
    [clickJudgment x="485" y="388" width="275" height="300" target="*LeftDimple" opacity="90" mouseopacity="120"]
[endif]
[if exp="f.dimple[1] == '' "]
    [clickJudgment x="795" y="388" width="275" height="300" target="*CenterDimple" opacity="90" mouseopacity="120"]
[endif]
[if exp="f.dimple[2] == '' "]
    [clickJudgment x="1118" y="388" width="275" height="300" target="*RightDimple" opacity="90" mouseopacity="120"]
[endif]
[s]
